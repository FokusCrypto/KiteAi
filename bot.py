        ...
        try:
            ...
            if claim_faucet:
                try:
                    ...
                    self.log(f"{Fore.RED + Style.BRIGHT}2captcha.txt not found. Stopping.{Style.RESET_ALL}")
                    return
            ...
            while True:
                ...
                for address in accounts:
                    if address:
                        ...
                        await self.process_accounts(address, agents, count, use_proxy, rotate_proxy, claim_faucet)
                        await asyncio.sleep(3)
